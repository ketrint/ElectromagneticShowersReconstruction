...
def main(
        datafile='./data/train_.pt', epochs=1000,
        learning_rate=1e-3, dim_out=144, device='cuda:3',
    ...
    for _ in tqdm(range(epochs)):
        ...
        torch.save(graph_embedder.state_dict(), "graph_embedder.pt")
        torch.save(edge_classifier.state_dict(), "edge_classifier.pt")
